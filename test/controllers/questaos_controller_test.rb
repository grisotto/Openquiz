...
class QuestaosControllerTest < ActionController::TestCase
  ...
  test "should create questao" do
    assert_difference('Questao.count') do
      post :create, questao: { dica: @questao.dica, pergunta: @questao.pergunta, resposta: @questao.resposta, tema_id: @questao.tema_id }
    end
  ...
  test "should update questao" do
    patch :update, id: @questao, questao: { dica: @questao.dica, pergunta: @questao.pergunta, resposta: @questao.resposta, tema_id: @questao.tema_id }
    assert_redirected_to questao_path(assigns(:questao))
  end
